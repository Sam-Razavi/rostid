...
describe('Modal', () => {
  ...
  it('renders title when provided', () => {
    render(<Modal isOpen onClose={vi.fn()} title="My Dialog">Body</Modal>);
  ...
  it('calls onClose when close button is clicked', () => {
    const onClose = vi.fn();
    render(<Modal isOpen onClose={onClose} title="Dialog">Content</Modal>);
  ...
  it('renders into document.body via portal', () => {
    render(<Modal isOpen onClose={vi.fn()}>Portaled</Modal>);
